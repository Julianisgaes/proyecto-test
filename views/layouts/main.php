...
<header id="header">
    ...
    echo Nav::widget([
        ...
        'items' => [
            ...
            ['label' => 'Base de datos', 'items' => [
                ['label' => 'Clientes', 'url' => ['/clientes/index']],
                ['label' => 'Compras', 'url' => ['/compras/index']],
                ['label' => 'Compras Helados', 'url' => ['/compras-helados/index']],
                ['label' => 'Helados', 'url' => ['/helados/index']],
                ['label' => 'Helados Insumos', 'url' => ['/helados-insumos/index']],
